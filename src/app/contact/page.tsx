  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      ...
      <div className="grid md:grid-cols-2 gap-8 lg:gap-12">
        <div className="bg-sdm-card rounded-lg p-6 sm:p-8 shadow-sm border border-sdm-border">
          <h2 className="font-display text-2xl font-bold text-sdm-text mb-6">
            Find Me Around the Web
          </h2>
          <div className="space-y-6">
            <div className="flex items-start space-x-4">
              <div className="w-12 h-12 bg-sdm-primary-subtle rounded-full flex items-center justify-center flex-shrink-0">
        ...
        <div className="bg-sdm-card rounded-lg p-6 sm:p-8 shadow-sm border border-sdm-border">
          ...
          <form className="space-y-6">
            <div>
              ...
              <input
                ...
                id="name"
                name="name"
                className="w-full px-4 py-3 border border-sdm-border-input rounded-md focus:outline-none focus:ring-2 focus:ring-sdm-primary focus:border-transparent transition-colors font-cooper"
                required
              />
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                name="message"
                rows={5}
                className="w-full px-4 py-3 border border-sdm-border-input rounded-md focus:outline-none focus:ring-2 focus:ring-sdm-primary focus:border-transparent resize-vertical transition-colors font-cooper"
          ...
          <div className="mt-6 p-4 bg-sdm-surface-subtle rounded-md">
